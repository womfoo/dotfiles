  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-jump-helm-line ace-link add-node-modules-path aggressive-indent
                          ...
                          company-ansible company-emoji company-go company-lua
                          company-web compat concurrent counsel counsel-css
                          counsel-gtags csv-mode ctable cython-mode dap-mode
                          deferred define-word devdocs diminish dired-quick-sort
                          dotenv-mode drag-stuff dumb-jump editorconfig elisp-def
                          elisp-slime-nav emmet-mode emoji-cheat-sheet-plus emr
                          enh-ruby-mode envrc epc eval-sexp-fu evil-anzu evil-args
                          ...
                          vc-darcs vi-tilde-fringe vim-powerline vmd-mode
                          volatile-highlights web-beautify web-completion-data
                          web-mode wfnames which-key winum writeroom-mode
                          ws-butler xcscope xref yaml-mode yapfify yasnippet)))
  (custom-set-faces
