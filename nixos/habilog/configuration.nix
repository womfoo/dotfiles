...
{ config, options, pkgs, lib, ... }:
{
  ...
  nixpkgs.config.packageOverrides = pkgs:
    {
      ...
      linux_armbian_rockchip64 = pkgs.linux_5_9.override {
        # generatd with
        #
        # for p in *.patch; do echo "{ name = \"${p%%.patch}\"; patch = prefix + ./$p; }"; done
        #
        kernelPatches = let prefix = ../armbian/patch/kernel/rockchip64-current; in [
          { name = "fix ios 14 tether"; patch = ./patches/kernel/5c2dd5283e5e694ea74dd6bb399950b8eda3bece.patch; }
  ...
  boot.initrd.mdadmConf = ''
    ARRAY /dev/md/nixos:0 level=raid1 num-devices=2 metadata=1.2 name=nixos:0 UUID=28865355:1ebf9b51:8b4191ca:a9bf583a
       devices=/dev/sda1,/dev/sdb1
    ARRAY /dev/md/nixos:1 level=raid1 num-devices=2 metadata=1.2 name=nixos:1 UUID=622fc7b7:7a5e10ae:7b70659f:24f1b2cb
