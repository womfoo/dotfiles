{ ... }:
{
 ...
 '';
  ...
  users.extraUsers.kranium = {
    name = "kranium";
    extraGroups = [ "wheel" "networkmanager" "audio" "docker" "vboxusers" "video" "lp" "dialout" "libvirtd" "qemu-libvirtd" "kranium" "kvm" "scanner" "cdrom"  "paperless"];
    group = "users";
    uid = 2000;
    createHome = true;
    home = "/home/kranium";
